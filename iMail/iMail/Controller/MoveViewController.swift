...
class MoveViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private func setupUI() {
        ...
        favoritosButton.tintColor = ThemeManager.shared.fetchThemeColors()?.labelColor
        lixeiraButton.tintColor = ThemeManager.shared.fetchThemeColors()?.labelColor
        spamButton.tintColor = ThemeManager.shared.fetchThemeColors()?.labelColor
        cxEntradaButton.tintColor = ThemeManager.shared.fetchThemeColors()?.labelColor
        cxEntradaTitleLabel.textColor = ThemeManager.shared.fetchThemeColors()?.labelColor
        titleLabel.textColor = ThemeManager.shared.fetchThemeColors()?.labelColor
    ...
    private func addTopLine(to view: UIView) {
        ...
        topLine.backgroundColor = ThemeManager.shared.fetchThemeColors()?.thirdColor
...
//        guard let themeColors = ThemeManager.shared.fetchThemeColors() else { return }
//        
//        
//    }
